...
### Generate Results
classification_report_out = "./Results/7_VGG19_PCA.txt"
f = open(classification_report_out, 'w')

#数据的目录
data_dir_train='./7/PCA/train'
#构造pathlib路径对象
...
def plot_learning_curves(history):
    ...
    plt.savefig('./Results/VGG19_PCA_7_curves.png')
    #plt.show()
...
pd.DataFrame(confmatrix).to_csv('./Results/7_VGG19_PCA_confusion_matrix.csv')
...
def ConfusionMatrixPlot(confmatrix_Input):    
   ...
   #cb.set_label('Numbers of Predict',fontsize = 15)
    plt.savefig('./Results/VGG19_PCA_7.png')
